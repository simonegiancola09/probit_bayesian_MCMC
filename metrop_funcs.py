import numpy as np
from linear_algebra_functions import eta, phi_normal, fisher_info
from bayes_functions import prior_Standard_Normal, prior_MLE, prior_uninformative, prior_t_student, likelihood, posterior_beta_Y
...
def MetropolisAlgorithm(Y, X, beta_0 = np.zeros((beta_true.shape[0],1)), tau = 1, burnin = 1000, iterations_after_burnin = 5000, \
                        print_warning_every = 500, prior = prior_MLE, log=False, verbose=True):
    '''
